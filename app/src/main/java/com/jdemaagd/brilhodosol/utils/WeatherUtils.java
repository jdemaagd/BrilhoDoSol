...
public final class WeatherUtils {
    ...
    /**
     * Temperature data is stored in Celsius
     * User preference may require it in Fahrenheit
     * Performs that temperature conversion if necessary
     * Also formats temperature so that no decimal points show
    ...
    /**
     * Format temperatures to be displayed in format: "HIGH°C / LOW°C"
     *
     * @param context Android Context to access preferences and resources
    ...
    /**
     * Returns wind String in following form: "2 km/h SW" (compass direction)
     *
     * @param context   Android Context to access preferences and resources
    ...
    /**
     * Provides string according to weather condition id returned by OWM call
     *
